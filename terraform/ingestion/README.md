...
| [aws_iam_role.tea_crawler_scheduler](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
...
| [aws_iam_role_policy.tea_crawler_scheduler_glue](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
...
| [aws_s3_object.connect20_evaluationinformation_prefix](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_object) | resource |
...
| [aws_s3_object.connect20_schedule12_prefix](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_object) | resource |
| [aws_s3_object.connect20_sessioninformation_prefix](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_object) | resource |
...
| <a name="input_tea_bronze_router_memory"></a> [tea\_bronze\_router\_memory](#input\_tea\_bronze\_router\_memory) | Lambda memory in MB for the TEA bronze router. Narrow CSVs are fully loaded into pandas for Parquet conversion; 512 MB is the recommended baseline. | `number` | `512` | no |
