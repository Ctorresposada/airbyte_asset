...
airbyte_alb_allowed_cidr_blocks = ["181.96.188.51/32", "38.46.246.237/32", "69.147.62.1/32", "190.53.0.160/32", "177.170.246.23/32", "189.6.208.52/32", "38.46.246.239/32"] # IPs allowed to reach the Airbyte ALB UI; empty locks everyone out (VPN off in prod)
