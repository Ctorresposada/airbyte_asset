...
# EC2 deployment variant — Caylent Sandbox (931366402038)
#
...
#   Copy the client ID and secret from there — no SSH or kubectl needed.
#
# workspace_id: open the Airbyte UI → copy the UUID from the URL, or go to Settings → General.
# airbyte_client_id and airbyte_client_secret: open the Airbyte UI → go to user- settings - Applications

airbyte_server_url    = "https://airbyte-dev.caylent-airbyte-asset.click/api/public/v1/"
airbyte_token_url     = "https://airbyte-dev.caylent-airbyte-asset.click/api/v1/applications/token"
