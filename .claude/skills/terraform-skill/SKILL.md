...
description: Use when working with Terraform - creating modules, writing tests (native test framework, Terratest), setting up CI/CD pipelines, reviewing configurations, choosing between testing approaches, debugging state issues, implementing security scanning (trivy, checkov), or making infrastructure-as-code architecture decisions
---

# Terraform Skill for Claude

Comprehensive Terraform guidance covering testing, modules, CI/CD, and production patterns. Based on terraform-best-practices.com and enterprise experience.

## When to Use This Skill

**Activate this skill when:**
- Creating new Terraform configurations or modules
...
- Cloud platform questions unrelated to Terraform
...
**Directory Structure:**
```
variables/     # Environment-specific configurations, we use tfvars and the DRY principle
├── prod.tfvars
├── staging
└── dev.tfvars
...
# Good: "this" for singleton resources (only one of that type) or module resources
