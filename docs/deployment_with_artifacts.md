...
│    • Triggers on paths: terraform/lambda/**             │
│                        src/lambda/mock/**                           │
└────────────────────┬────────────────────────────────────────────────┘
                     │
                     ▼
...
│       • Pass image version:                                         │
│         -var lambda_image_version=<image-version>       │
...
┌─────────────────────────────────────────────────────────────────────┐
│ 1. Pull Request Created                                             │
│    • Triggers on paths: terraform/base/**               │
│                        .github/workflows/terraform_base.yml│
└────────────────────┬────────────────────────────────────────────────┘
                     │
                     ▼
...
│         tfplan-base-pr-<number>-dev                     │
│         tfplan-base-pr-<number>-staging                 │
│         tfplan-base-pr-<number>-prod                    │
...
Environment-specific variables in `terraform/lambda/variables/<environment>.tfvars`:
...
# lambda_image_version = "sha-abc1234"
```
